...
<div class="grid grid-cols-1 sm:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-[#660809] text-white p-6 rounded-xl shadow flex items-center gap-4">
        <div class="flex items-center justify-center w-12 h-12 rounded-full bg-yellow-100">
            <iconify-icon icon="mdi:clock-outline" class="text-yellow-600 text-2xl"></iconify-icon>
        </div>
        <div>
    ...
    <div class="bg-[#660809] text-white p-6 rounded-xl shadow flex items-center gap-4">
        <div class="flex items-center justify-center w-12 h-12 rounded-full bg-purple-100">
            <iconify-icon icon="mdi:currency-php" class="text-purple-600 text-2xl"></iconify-icon>
        </div>
        <div>
