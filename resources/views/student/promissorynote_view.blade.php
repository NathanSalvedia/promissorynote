...
<style>
  /* scrolling marquee effect for black strip */
      ...
      <div class="max-w-7xl mx-auto flex justify-between items-center px-6 py-3">
        ...
        <div class="flex items-center gap-4">
          <a href="{{ route('student.dashboard') }}"
             class="inline-flex items-center gap-2 bg-[#660809] text-white px-4 py-2 rounded-md shadow hover:bg-black transition">
            <iconify-icon icon="mdi:arrow-left-circle-outline" class="text-lg"></iconify-icon>
            Back to Dashboard
          </a>
        </div>
