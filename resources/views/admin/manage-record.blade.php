  ...
  <div class="min-h-screen bg-gray-50 py-8 px-4">
    ...
    <div class="max-w-6xl mx-auto">
      ...
      {{-- 🔙 Back Button (Top Only - Branded Color) --}}
      ...
      <form method="GET" action="{{ route('admin.manage-record') }}" 
            class="flex flex-col md:flex-row md:items-end gap-4 w-full justify-between mb-6">
        
        {{-- Search --}}
        <div class="flex-1">
          <label for="search" class="text-sm font-medium text-gray-700 mb-1 block">Search by Course</label>
          <div class="relative">
        ...
        <div class="w-full md:w-60">
          <label for="department" class="text-sm font-medium text-gray-700 mb-1 block">Filter by Department</label>
        ...
        {{-- Button --}}
        <div>
          <button type="submit" class="bg-[#660809] text-white px-6 py-2 rounded-lg shadow hover:bg-red-800 transition">
            Apply
          </button>
        </div>
      </form>
