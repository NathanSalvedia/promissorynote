...
<div class="bg-gradient-to-b from-white to-gray-100 min-h-screen py-2">
    <div class="max-w-5xl mx-auto p-4">
        <div class="flex items-center justify-between mb-4">
            <h2 class="text-2xl font-bold text-gray-800">
                Account Subledger for {{ $user->fullname }} ({{ $user->student_id }})
            </h2>
            <a href="{{ route('admin.dashboard') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded shadow">&laquo; Back</a>
        </div>
