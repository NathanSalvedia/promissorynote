...
<header class="w-full">
    ...
    {{-- ✅ Navbar --}}
    <div class="bg-white shadow dark:bg-gray-900 dark:text-white transition duration-300">
        <div class="max-w-10xl mx-auto grid grid-cols-[auto_1fr_auto] items-center gap-4 md:gap-8 px-5 py-1.5">
            <div class="flex items-center gap-2 md:gap-3">
                <img src="{{ asset('img/spc-wordmark.png') }}" alt="SPC Wordmark" class="h-12 md:h-16 object-contain">
            </div>
            ...
            <div class="flex items-center gap-3">
                {{-- 🌗 Theme toggle --}}
                <button id="theme-toggle" class="text-[#660809] dark:text-yellow-400 hover:text-black dark:hover:text-white text-lg">
...
<div class="relative min-h-[calc(100vh-120px)] overflow-hidden transition duration-300">
    ...
    <div id="slideshow" class="absolute inset-0 w-full h-full z-0 overflow-hidden">
        <img src="{{ asset('img/background1.jpg') }}" class="slide active" alt="Background 1">
        <img src="{{ asset('img/background2.jpg') }}" class="slide" alt="Background 2">
        <img src="{{ asset('img/background3.jpg') }}" class="slide" alt="Background 3">
    </div>
...
<div id="loading-overlay" class="fixed inset-0 bg-black/40 flex items-center justify-center opacity-0 pointer-events-none transition-opacity duration-500 z-50">
    <div class="bg-white/10 backdrop-blur-md border border-white/20 text-white px-8 py-6 rounded-2xl shadow-2xl flex flex-col items-center animate-fadeIn">
        <img src="{{ asset('img/logo.png') }}" alt="SPC Logo" class="spc-logo mb-3 w-28 animate-bounce">
