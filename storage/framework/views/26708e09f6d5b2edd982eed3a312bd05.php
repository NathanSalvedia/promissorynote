                ...
                <?php if($note->status !== 'approved'): ?>
                    ...
                    <div id="rejectModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40 hidden">
                        <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6 relative">
                            ...
                            <form action="<?php echo e(route('admin.promissorynote.deny', $note->pn_id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\promissorynote-app\resources\views/admin/promissorynote-detail.blade.php ENDPATH**/ ?>