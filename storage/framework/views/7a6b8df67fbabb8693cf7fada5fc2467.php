...
<div class="bg-gradient-to-b from-gray-200 to-gray-100 min-h-screen py-2">
    <div class="max-w-5xl mx-auto p-4">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-4 py-2 rounded shadow">&laquo; Back</a>
        </div>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\promissorynote-app\resources\views/admin/student-subledger.blade.php ENDPATH**/ ?>