...
<div class="relative min-h-[calc(100vh-120px)] overflow-hidden">
    ...
    <div id="slideshow" class="absolute inset-0 w-full h-full z-0">
        <img src="<?php echo e(asset('img/background1.jpg')); ?>" class="slide active" alt="Slide 1">
        <img src="<?php echo e(asset('img/background2.jpg')); ?>" class="slide" alt="Slide 2">
        <img src="<?php echo e(asset('img/background3.jpg')); ?>" class="slide" alt="Slide 3">
    </div>
