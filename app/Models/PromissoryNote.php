...
class PromissoryNote extends Model
{
    ...
    protected $fillable = [
        'user_id', 'fullname', 'student_id', 'gender', 'course', 'department', 'phone', 'year_level', 'amount', 'reason', 'term', 'academic_year', 'down_payment', 'due_date', 'notes', 'attachments', 'status', 'is_settled'
    ];
    /**
